    ...
    try:
        ...
        if work_record:
            ...
            cursor.execute(
                ...
                (work_summary, data.get('start_time'), data.get('end_time'), data.get('break_time'), work_record['record_id'])
            )
        else:
            ...
            cursor.execute(
                ...
                (employee_id, date, work_summary, data.get('start_time'), data.get('end_time'), data.get('break_time'))
            )
